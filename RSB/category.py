...
class Category:
    def __init__(self, public_name: str, file_name: str, size: int):
    ...
    def _serialize_dir(self) -> list:
        return self.file_name.split(os.path.sep)
